...
4.Download our pretrained models, and supplementary from this link One Drive and extract it to `${DCPose_SUPP_DIR} `directory.
...
# Evaluate on the PoseTrack18 validation set
python run.py --cfg ../configs/posetimation/DcPose/posetrack18/model_RSN_trained.yaml --val  
# Evaluate on the PoseTrack18 test set
python run.py --cfg ../configs/posetimation/DcPose/posetrack18/model_RSN_trained.yaml --test
```
